                    ...
                    <div className="h-56 sm:h-64 xl:h-100 2xl:h-96 overflow-hidden w-[50%] rounded-2xl">
                        <Carousel>
                            {hotel.images.gallery.map((img) => (
                                <div key={img.id}>
                                <figure className='h-full'><img className='h-full' src={img} alt="" /></figure>
                                </div>
                            ))
                            }
                        </Carousel>
                    ...
                    <div className='!pl-8 w-[45%]'>
                        ...
                        <div className='flex justify-between items-center w-full !mb-2'>
                            ...
                            <div className=''> 
                                ...
                                <p className='text-[#191D23] text-[32px] font-bold'>{hotel.pricing[0].discountedPrice} <span className='text-[#191d2357] text-xs'>{hotel.pricing[0].currency}</span></p>
