...
function BookingForm() {
  ...
  return (
    <>
      <form className="w-[68%] mx-auto bg-white !p-8 rounded-lg shadow-md ">
        ...
        <div className='!mt-4'>
          ...
          <button onClick={handelBooking} type='submit' className="w-full bg-blue-600 text-white !py-2 rounded-md font-semibold hover:bg-blue-700 transition-all cursor-pointer">
            PAY NOW
          </button>
        </div>
      </form>
